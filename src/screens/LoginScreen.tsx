    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      <View style={styles.container}>
        ...
        <ImageBackground 
          ...
          defaultSource={require('../../assets/images/welcome1.webp')}
          fadeDuration={0}
                    ...
                    <View style={styles.headerSection}>
                      <View style={styles.logoWrapper}>
                        <Image
                          ...
                          defaultSource={require('../../assets/images/logo1.webp')}
                          fadeDuration={0}
...
const styles = StyleSheet.create({
  ...
  safeContent: { paddingTop: 16, paddingBottom: 40 },
  ...
  footerContainer: { position: 'absolute', bottom: 16, width: '100%', alignItems: 'center' },
